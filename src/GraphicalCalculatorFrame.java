...
public class GraphicalCalculatorFrame extends JFrame
{
    ...
    /**
     * Interactive panel that the user clicks on to modify portions of an equation.
     * The panel effectively works as a simple equation editor. The panel has 5
     * regions that may be clicked - 3 operand regions and 2 operator regions. That
     * is, the Panel displays an expression with 5 editable regions. Regions are
     * marked by a black bounding box and when the region is clicked it is
     * "selected" and highlighted yellow.
     *
     * The equation represented by this panel is of the form: operand0 operator0
     * operand1 operator1 operand2 = result
     */
    ...
    private final class GraphicalCalculatorPanel extends JPanel implements MouseListener
    {
        ...
        /**
         * The editable regions. These are stored as rectangles to represent where to
         * draw them as well as to represent the area on the panel that selects the
         * region when clicked.
         *
        ...
        /**
         * The points at which the parts of the equation are drawn (operators, operands,
         * = sign, result). The regions are drawn around the displayed text for the
         * editable parts of the equation.
         */
        Point[] textPoints;
        ...
        /**
         * The operands of the equation. Used for evaluation and for drawing the
         * expression.
         */
        private int[] operands = { 0, 0, 0 };

        /**
         * The operators of the equation. Used for evaluation and for drawing the
         * expression.
         */
         ...
         *
         * The regions are associated with the operands and operators as such: region0 =
         * operand0 region1 = operator0 region2 = operand1 region3 = operator1 region4 =
         * operand2
         */
        private void setupRegions()
        {
            // TODO: create the regions. The first regions should be located at
            ...
            regions[3] = new Rectangle(textPoints[3], new Dimension(REGION_WIDTH, REGION_HEIGHT));
            regions[4] = new Rectangle(textPoints[4], new Dimension(REGION_WIDTH, REGION_HEIGHT));
        }
        ...
        /**
         * When the panel is clicked, check if the point clicked lies within any of the
         * editable regions of the expression. If so, that region set to the be the new
         * selected region. Repaint at the end.
         *
         * (hint: look at the java.awt.Rectangle class for useful methods that you can
         * use to check if a point is within the rectangle)
         */
        @Override
        public void mouseClicked(MouseEvent e)
        {
            // If the mouse clicked within a region, set that region to be the selected
            // region.
        ...
        /**
         * Attempts to set the content of the selected region. If the region is and
         * operand the content must be a single-digit number (0-9). If the region is an
         * operator the content must be "+", "-", or "*".
         *
         * Should call repaint at the end.
         *
         * @param content The value that the program will attempt to set the selected
         *                region to.
        ...
        public boolean setSelectedRegionContents(String content)
        {
             ...
             *
             * Remember that the regions are associated with the operand and operators as
             * such: region0 = operand0 region1 = operator0 region2 = operand1 region3 =
             * operator1 region4 = operand2
             *
        ...
        /**
         * Evaluates the equation on the panel. Operations are performed left-to-right,
         * ignoring operator precendence (e.g. and equation of 2+3*4 will return (2+3)*4
         * = 20)
         *
        ...
        public int evaluate()
        {
            // TODO: evaluate the expression. (operand0 operator0 operand1) operator1
            // operand2
        }
    ...
    /**
     * Button to attempt to set the selected region in the Graphical panel to the
     * value in the operand entry text field.
     */
    ...
    /**
     * Button to attempt to set the selected region in the Graphical panel to the
     * selected operator (as defined by the radio buttons).
     */
